...
public class CadtController {
    ...
    private Item generateItem(DroolsSubmittedForm droolsSubmittedForm) {
        ...
        final List<Facet<?>> facets = createCadtFacets(formVariables, droolsSubmittedForm.getSubmittedAt());
    ...
    private List<Facet<?>> createCadtFacets(Map<String, Object> formVariables, LocalDateTime submittedTime) {
        //Score by archetypes
