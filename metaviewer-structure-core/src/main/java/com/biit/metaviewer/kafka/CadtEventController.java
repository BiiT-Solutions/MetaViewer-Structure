...
public class CadtEventController {
    ...
    public CadtEventController(EventListener eventListener, CadtScoreController cadtScoreController, CadtValueController cadtValueController) {
