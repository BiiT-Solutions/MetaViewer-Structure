...
public class SwaggerConfiguration extends DefaultSwaggerConfiguration {
    private static final String SWAGGER_TITLE = "MetaViewer Structure";
    private static final String SWAGGER_DESCRIPTION = "";
    private static final String SWAGGER_GROUP = "rest-public";

    private static final String[] PACKAGES_TO_SCAN = new String[]{"com.biit.metaviewer.rest", "com.biit.server.rest", "com.biit.server.security.rest"};
